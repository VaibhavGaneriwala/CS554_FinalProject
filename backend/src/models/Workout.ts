...
const WorkoutSchema = new Schema<IWorkout>(
    {
        ...
        split: {
            ...
            enum: {
                values: ['Push', 'Pull', 'Legs', 'Upper Body', 'Lower Body', 'Full Body', 'Chest', 'Back', 'Shoulders', 'Arms', 'Core', 'Cardio', 'Other',], message: '{VALUE} is not a valid split type',
            },
        },
        exercises: {
            type: [ExerciseSchema],
            validate: {
                validator: function (exercises: IExercise[]){return exercises.length > 0;}, message: 'Workout must have at least one exercise',
            },
        },
        date: {
            type: Date,
